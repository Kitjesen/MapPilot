...
struct TopicStats {
  ...
  double hz() const {
    if (samples < 2 || last_ts <= first_ts) {
      return 0.0;
    }
    return static_cast<double>(samples - 1) / (last_ts - first_ts);
  }
};
...
const TopicSpec kSpecs[] = {
    ...
    {lingtu::message::kGnssOdom.topic, lingtu::message::kGnssOdom.dds_topic,
     &lingtu_dds_Odometry_desc, Kind::Odometry, alloc_odometry, free_odometry},
    {lingtu::message::kSlamMapCommand.topic, lingtu::message::kSlamMapCommand.dds_topic,
     &lingtu_dds_Text_desc, Kind::Text, alloc_text, free_text},
    {lingtu::message::kSlamMapEvent.topic, lingtu::message::kSlamMapEvent.dds_topic,
     &lingtu_dds_Text_desc, Kind::Text, alloc_text, free_text},
    ...
    {lingtu::message::kNavGoalPose.topic, lingtu::message::kNavGoalPose.dds_topic,
     &lingtu_dds_PoseStamped_desc, Kind::PoseStamped, alloc_pose_stamped, free_pose_stamped},
    {lingtu::message::kNavCancel.topic, lingtu::message::kNavCancel.dds_topic,
     &lingtu_dds_Text_desc, Kind::Text, alloc_text, free_text},
    ...
    {lingtu::message::kNavTeleopCmdVel.topic, lingtu::message::kNavTeleopCmdVel.dds_topic,
     &lingtu_dds_TwistStamped_desc, Kind::TwistStamped, alloc_twist_stamped, free_twist_stamped},
