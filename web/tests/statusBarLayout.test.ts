...
test('navigation axes are rendered from the live navigation status projection', () => {
  assert.match(statusSource, /presentNavigationStatus\(navigation/)
  assert.match(statusSource, /navigationView\.task\.label/)
  assert.match(statusSource, /navigationView\.goalAdmission\.label/)
  assert.match(statusSource, /navigationView\.control\.label/)
  assert.match(statusSource, /navigationView\.motion\.permission\.label/)
  assert.match(statusSource, /navigationView\.motion\.stopConfirmation\.label/)
