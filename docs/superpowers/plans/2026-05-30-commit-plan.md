...
> **Historical / evidence status**: Restored as valid UTF-8 from commit `df57d5b6`, the last clean version found in git history. The later `c6606872` copy is lossy mojibake/invalid UTF-8; treat this as a 2026-05-30 worktree triage record, not a current commit plan, unless re-verified.
>
