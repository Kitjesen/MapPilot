...
> **Historical / evidence status**: Restored as valid UTF-8 from commit `818e6d5b`, the last clean version found in git history. The later `c6606872` copy is lossy mojibake/invalid UTF-8; use this as a 2026 Q2 review record and independently re-check paths/status before treating it as current implementation guidance.
>
