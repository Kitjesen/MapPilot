...
### `save_map`
**Module:** `MapManagerModule`
**Description:** Save current SLAM map as *name* (ROS2 SaveMaps) and build all artifacts.
**Return type:** `str`
**Parameters:**
| Parameter | Type |
|-----------|------|
...
### `tune_bbox_gains`
**Module:** `VisualServoModule`
**Description:** Run Ziegler-Nichols relay-based PD gain auto-tuning for BBoxNavigator.
**Return type:** `dict`
**Parameters:**
| Parameter | Type |
|-----------|------|
...
**Description:** Return GNSS-SLAM fusion health: alignment, residual, fix quality,
**Return type:** `str`
**Parameters:** None

### `relock_gnss_alignment`
**Module:** `SlamBridgeModule`
**Description:** Force re-locking of the GNSS↔SLAM alignment offset. The next
**Return type:** `str`
**Parameters:** None

### `set_gnss_fusion`
**Module:** `SlamBridgeModule`
**Description:** Enable or disable the GNSS-SLAM fusion runtime switch. When
**Return type:** `str`
**Parameters:**
| Parameter | Type |
|-----------|------|
