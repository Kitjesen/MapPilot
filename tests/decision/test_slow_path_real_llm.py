...
@unittest.skipIf(not os.getenv("OPENAI_API_KEY"), "Skipping real LLM tests (no API key)")
class TestSlowPathRealLLM(unittest.TestCase):
    """Test Slow Path Real L L M."""
    ...
    def test_real_llm_simple_navigation(self):
        """Test real llm simple navigation."""
        objects = [
            {
                "id": 0,
                "label": "red chair",
    ...
    def test_real_llm_spatial_reasoning(self):
        """Test real llm spatial reasoning."""
        objects = [
            {
                "id": 0,
                "label": "chair",
    ...
    def test_real_llm_with_esca_filtering(self):
        """Test real llm with esca filtering."""
    ...
    def test_real_llm_chinese_instruction(self):
        """Test real llm chinese instruction."""
        objects = [
            {
                "id": 0,
                "label": "灭火器",
