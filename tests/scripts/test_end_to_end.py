...
print("   - Product navigation through native DDS (requires a running Product)")
print()
print("Next steps:")
print("   1. Test detector and encoder in a real environment")
print("   2. Configure an LLM API key to test Slow Path")
print("   3. Validate the full pipeline through ProductControl and native DDS in simulation")
print("   4. Measure native runtime performance on the S100P/RDK X5 target")
print()
print("=" * 80)
