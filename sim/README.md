...
| G7 — ProductControl/RunPlan | Resolved Physics, Visual, Sensor, Control, Transport, and optional Scenario bundle | Pass: `tests/lingtu/assembly/test_simulation.py` passes all 27 tests |
