...
| G7 | Single-RunPlan Product integration | Pass | ProductControl/RunPlan carries Physics, Visual, Sensor, Control, Transport, and optional Scenario bundle; `tests/lingtu/assembly/test_simulation.py` passes all 27 tests. Preserve single-source resolution. |
