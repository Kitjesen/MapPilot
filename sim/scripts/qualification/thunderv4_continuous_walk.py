...
import numpy as np
from sim.engine.core.engine import RobotState, VelocityCommand
from drivers.sim.mujoco.runtime import build_engine

REPO_ROOT = Path(__file__).resolve().parents[3]
WORLD_XML = REPO_ROOT / "sim" / "worlds" / "mujoco" / "open_field.xml"
ROBOT_XML = REPO_ROOT / "sim" / "robots" / "doso" / "thunder_v4" / "mjcf" / "thunderv4.xml"
POLICY = (
    REPO_ROOT
    / "sim"
    / "controllers"
