...
def _launch_headless() -> tuple[subprocess.Popen[str], queue.Queue[str | None]]:
    ...
    process = subprocess.Popen(  # noqa: S603 - test uses a fixed repo-local binary path.
        [
            ...
            SESSION_ID,
            "5",
            str(REPO_ROOT / "sim/runtime/physics/tests/fixtures/scene_world.xml"),
            "--global-policy",
            "0.002",
            "rk4",
            "newton",
            ...
            "--robot",
            "robot",
            str(REPO_ROOT / "sim/runtime/physics/tests/fixtures/actuated_hinge.xml"),
            "test_body",
            "0",
            "0",
            "0",
...
def _launch_thunder_headless() -> tuple[
    ...
    process = subprocess.Popen(  # noqa: S603 - fixed repo-local runtime and assets.
        [
            ...
            THUNDER_SESSION_ID,
            "4",
            str(REPO_ROOT / "sim/worlds/mujoco/open_field.xml"),
            "--global-policy",
            "0.001",
            "rk4",
            "newton",
            ...
            "--robot",
            "thunder_01",
            str(REPO_ROOT / "sim/robots/doso/thunder_v4/mjcf/thunderv4.xml"),
            "base_link",
            "0",
            "0",
            "0",
