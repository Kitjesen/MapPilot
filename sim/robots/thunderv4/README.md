...
```powershell
python D:\inovxio\brain\lingtu\sim\robots\thunderv4\tools\generate_thunderv4_mjcf.py
python D:\inovxio\brain\lingtu\sim\robots\thunderv4\tools\generate_thunderv4_mjcf.py --scene stairs
python D:\inovxio\brain\lingtu\sim\robots\thunderv4\tools\check_thunderv4_hardware.py
```
