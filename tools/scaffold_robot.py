...
Usage:
    python tools/scaffold_robot.py <name> --type quadruped
    python tools/scaffold_robot.py <name> --type wheeled
    python tools/scaffold_robot.py <name> --type quadruped --policy path/to/policy.onnx
    python tools/scaffold_robot.py <name> --type wheeled --meshes path/to/meshes
"""
    ...
    return json.dumps(
        {
            ...
            "asset": fname,
            "sha256": sha,
            "source_note": "Scaffolded by tools/scaffold_robot.py",
