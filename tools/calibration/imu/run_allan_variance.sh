...
#
# Background:
#   The Fast-LIO2 IMU noise params (na/ng/nba/nbg) ship at
...
#   apply    tools/calibration/apply_calibration.py → selected Fast-LIO2 YAML
#
# Usage:
#   bash tools/calibration/imu/run_allan_variance.sh all              # 3h end-to-end
#   bash tools/calibration/imu/run_allan_variance.sh record           # just record
#   bash tools/calibration/imu/run_allan_variance.sh analyze <path>   # analyze existing bag
#   bash tools/calibration/imu/run_allan_variance.sh apply <imu.yaml> # apply existing yaml
#
# Env overrides:
