...
struct Config
{
    ...
    double imu_static_acc_thresh  = 0.04;   // m/s^2: RMS acceleration deviation and gravity-magnitude error
    double imu_static_gyro_thresh = 0.001;  // rad/s: RMS gyro deviation and bias-compensated mean
