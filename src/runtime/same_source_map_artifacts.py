...
def _load_build_tomogram_from_pcd() -> Any:
    try:
        ...
        raise ModuleNotFoundError(
            ...
            "nav.services.plan.global_planner.algorithm.pct.vendor.pct_planner tomography/scripts"
        ) from last_exc
...
def build_tomogram_artifact(
    *,
    ...
    # Lazy: PCT is a nav planning package. This import stays inside the
    # function so runtime/ modules do not import planning backends at module load.
