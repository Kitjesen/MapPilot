"""File-backed driver catalog helpers for local Host Profiles."""
...
def driver_catalog_runtime_defaults(name: str) -> dict[str, dict[str, Any]]:
    return _copy_mapping_of_mappings(driver_catalog(name), "runtime_defaults")
