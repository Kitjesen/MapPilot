...
def _compiled_product_config(product_name: str) -> dict:
    ...
    return {
        **manifest.host_config,
        "native_control_mode": manifest.lifecycle["native_control_mode"],
...
def test_nav_product_compiles_native_endpoint_motion_parameters() -> None:
    ...
    assert payload["parameters"] == {
        ...
        "path_follower_max_yaw_rate_rad_s": 0.8,
    ...
    expected_environment = {
        ...
        "LINGTU_NAV_PATH_FOLLOWER_MAX_YAW_RATE_RAD_S": "0.8",
