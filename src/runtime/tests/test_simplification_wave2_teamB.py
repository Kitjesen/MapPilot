...
def _make_bbox_navigator():
    ...
    with mock.patch(
        "decision.vision.bbox_navigator.get_config", return_value=mock_cfg
    ):
        from decision.vision.bbox_navigator import BBoxNavConfig, BBoxNavigator
...
class TestW211VlmBboxQueryRetryCache(unittest.TestCase):
    ...
    def setUp(self):
        ...
        import decision.vision.vlm_bbox_query as mod
