...
# =========================================================================
# Test 33: No API key startup 鈥?system.build() succeeds
# =========================================================================
...
# =========================================================================
# Test 34: No CLIP startup 鈥?EncoderModule doesn't crash
# =========================================================================
...
# =========================================================================
# Test 35: Empty SceneGraph 鈥?no crash, no goal_pose published
# =========================================================================
...
def test_36_waypoint_tracker_stuck():
    ...
    # Update with same position repeatedly 鈥?should trigger stuck
    events_seen = []
