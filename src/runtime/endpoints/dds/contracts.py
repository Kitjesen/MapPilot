"""Typed DDS communication contract for the Thunder robot."""
...
THUNDER_DDS_CONTRACT_NAME = "thunder_dds_v1"
...
THUNDER_DDS_CONTRACT = DDSEndpointContract(
    name=THUNDER_DDS_CONTRACT_NAME,
    ...
    bindings=(
        ...
        _binding(
            ...
            direction="endpoint_to_lingtu",
            schema="lingtu.dds.ExplorationRunEvent",
            note=(
...
_CONTRACTS: dict[str, DDSEndpointContract] = {
    THUNDER_DDS_CONTRACT.name: THUNDER_DDS_CONTRACT,
}
