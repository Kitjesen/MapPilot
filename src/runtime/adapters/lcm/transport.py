"""LCM transport used only by the legacy LCM endpoint adapter."""
...
from runtime.transport.abc import Publisher, Subscriber, TopicConfig, TransportABC
...
class LCMPublisher(Publisher):
    ...
    def publish(self, msg: Any) -> None:
        if not isinstance(msg, (bytes, bytearray)):
            raise TypeError("LCMPublisher expects bytes")
...
class LCMTransport(TransportABC):
    """LCM backend for compatibility endpoint processes."""
