...
constexpr std::array<Component, 9> kComponents{{
    {
        ...
        "livox_sdk2_stream",
        "managed by Product process 'lidar'",
    ...
    },
    {
        ...
        "slamd",
        "managed by Product process 'slam'",
    ...
    },
    {
        ...
        "src/localization/slam/cpp",
        "slamctl",
        "use Gateway restart/relocalize controls or call slamctl directly on the robot",
    ...
    },
    {
        ...
        State::Ready,
        "src/nav/cpp/endpoint",
        "navd",
        "managed by Product process 'nav'",
        "Native navigation endpoint for goal intake, selected OctoPlanner3D/FAR planning, local target selection, path following, and cmd_vel publication.",
        true,
        false,
    },
    {
    ...
    },
    {
        ...
        "managed by Product process 'traversability'",
