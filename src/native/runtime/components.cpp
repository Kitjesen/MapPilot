...
constexpr std::array<Component, 9> kComponents{{
    {
        ...
        "livox_sdk2_stream",
        "managed by RuntimePlan process 'lidar'",
    ...
    },
    {
        ...
        "managed by RuntimePlan process 'slam'",
    ...
    },
    {
        ...
        "navd",
        "managed by RuntimePlan process 'nav'",
    ...
    },
    {
        ...
        "managed by RuntimePlan process 'traversability'",
