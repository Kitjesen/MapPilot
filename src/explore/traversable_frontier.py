...
Navigation/VelocityMux/SafetyRing. The module never publishes cmd_vel and
is not wired to Navigation by default.
"""
...
class TraversableFrontierModule(WavefrontFrontierExplorer):
    ...
    def health(self) -> dict[str, Any]:
        ...
        info["traversable_frontier"] = {
            ...
            "command_owner": "Navigation/VelocityMux/SafetyRing",
