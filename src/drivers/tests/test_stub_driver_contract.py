"""Contract tests for StubDogModule — port shape, lifecycle, spec compliance.

Verifies StubDogModule satisfies the MotionDriver contract from
``drivers.spec``, exposes the correct In/Out port types, and has
...
try:
    __import__("core.blueprints.stub")
except ImportError:
    pass
