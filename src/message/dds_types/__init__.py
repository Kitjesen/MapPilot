...
_EXPORTS: dict[str, str] = {
    ...
    "DDS_MapMetaData": ".nav",
    "DDS_MapArtifactIdentity": ".nav",
    "DDS_MapIdentity": ".nav",
    "DDS_MapActivationRequest": ".nav",
    "DDS_MapActivationAck": ".nav",
    ...
    "LivoxPoint": ".livox",
    "MapMetaData": ".nav",
    "MapArtifactIdentity": ".nav",
    "MapIdentity": ".nav",
    "MapActivationRequest": ".nav",
    "MapActivationAck": ".nav",
    "MapCloudLayer": ".nav",
    "MapGrid": ".nav",
    "MapObservation": ".nav",
    "MapRuntimeState": ".nav",
