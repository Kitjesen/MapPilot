...
from nav.mission.model.geometry import point_summary
from nav.mission.model.policy import should_use_direct_goal_fallback
from nav.mission.model.state import MissionEvent, MissionState, MissionStateInput, mission_state_name
...
class NavigationPlanningMixin:
    ...
    def _publish_plan_report(self) -> None:
        ...
        planner_name = (
            ...
            or planner_service_name(self._planner_svc, selected)
        )
