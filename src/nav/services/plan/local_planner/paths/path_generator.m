...
%   correspondences.txt 鈥?voxel_id 鈫?[blocked path_ids] mapping
%
% The generated files are committed to the repository and consumed at runtime
% by both the C++ LocalPlannerCore (via local_planner.hpp load_paths())
% and the Python cmu_py fallback backend (path_tables.py).
%
...
%   3. Rebuild nav_kernel: bash scripts/build/build_nav_kernel.sh
%
