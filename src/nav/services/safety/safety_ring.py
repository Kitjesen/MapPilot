"""SafetyRing -unified safety + evaluation + dialogue in one Module.
...
from runtime.msgs.semantic import ExecutionEval, SafetyState
...
class SafetyRing(Module, layer=0):
    ...
    def _publish_safety(self):
        ...
        # auditing through nav.velocity_mux.driver_cmd_vel. Suppress only re-entrant
