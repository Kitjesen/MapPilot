...
void bind_terrain(nb::module_& m) {
  nb::class_<TerrainParams>(m, "TerrainParams")
    ...
    .def_rw("check_terrain_connectivity", &TerrainParams::checkTerrainConnectivity)
    .def_rw("terrain_under_vehicle", &TerrainParams::terrainUnderVehicle)
    .def_rw("terrain_connection_height", &TerrainParams::terrainConnectionHeight)
    .def_rw("ceiling_filtering_height", &TerrainParams::ceilingFilteringHeight)
    .def_rw("terrain_connectivity_radius_cells", &TerrainParams::terrainConnectivityRadiusCells)
    .def_rw("ground_seed_search_radius_cells", &TerrainParams::groundSeedSearchRadiusCells)
    .def_rw("max_ground_seed_error", &TerrainParams::maxGroundSeedError)
    .def_rw("clear_dy_obs", &TerrainParams::clearDyObs)
    .def_rw("min_dy_obs_dis", &TerrainParams::minDyObsDis)
    .def_rw("min_dy_obs_angle", &TerrainParams::minDyObsAngle)
    .def_rw("min_dy_obs_rel_z", &TerrainParams::minDyObsRelZ)
    .def_rw("abs_dy_obs_rel_z_thre", &TerrainParams::absDyObsRelZThre)
    .def_rw("min_dy_obs_vfov", &TerrainParams::minDyObsVFOV)
    .def_rw("max_dy_obs_vfov", &TerrainParams::maxDyObsVFOV)
    .def_rw("min_dy_obs_point_num", &TerrainParams::minDyObsPointNum)
    .def_rw("min_out_of_fov_point_num", &TerrainParams::minOutOfFovPointNum)
    .def_rw("obstacle_height_thre", &TerrainParams::obstacleHeightThre)
    .def_rw("no_data_obstacle", &TerrainParams::noDataObstacle)
    .def_rw("no_data_block_skip_num", &TerrainParams::noDataBlockSkipNum)
    .def_rw("min_block_point_num", &TerrainParams::minBlockPointNum)
    .def_rw("vehicle_height", &TerrainParams::vehicleHeight)
    .def_rw("voxel_point_update_thre", &TerrainParams::voxelPointUpdateThre)
    .def_rw("voxel_time_update_thre", &TerrainParams::voxelTimeUpdateThre)
  ...
  nb::class_<TerrainResult>(m, "TerrainResult")
    ...
    .def_rw("connectivity_map", &TerrainResult::connectivity_map)
    .def_rw("connected_cells", &TerrainResult::connected_cells)
    .def_rw("ceiling_cells", &TerrainResult::ceiling_cells)
