...
lingtu::nav::endpoint::RigidTransform transform(double x, double roll_rad, double stamp_s) {
...
lingtu::nav::endpoint::RigidTransform yawTransform(double x, double yaw_rad, double stamp_s) {
...
int main() {
  ...
  require(!lingtu::nav::endpoint::rigidTransformFromOdometry(invalid_odom).valid,
