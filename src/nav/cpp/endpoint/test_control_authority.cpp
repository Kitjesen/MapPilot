...
void testOperatorTakeoverBlocksOldAndNewPathsUntilExplicitResume() {
  ...
  require(
      authority.beginOperatorTakeover({0.2, 0.0, 0.1}, 10.0),
  ...
  require(
      authority.operatorTakeoverLatched(),
      "manual hold must retain operator ownership");
  require(
      !authority.teleopRequest().has_value(),
      "manual hold must clear the last velocity sample");
  require(
      authority.resumeAutonomy(),
      "explicit resume must release the takeover latch when estop is clear");
  require(
      !authority.operatorTakeoverLatched(),
      "explicit resume must release operator ownership");
  require(
      authority.activatePath(),
...
void testEstopRequiresExplicitClearAndNeverResumesOldMotion() {
  ...
  require(
      !authority.clearEstop(false),
      "failed zero publication must not release estop");
