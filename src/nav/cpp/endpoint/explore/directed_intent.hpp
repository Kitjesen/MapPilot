...
class DirectedExplorationIntentStore final {
 public:
  ...
  [[nodiscard]] DirectedExplorationIntentResult Set(const std::string &product_session_id,
  ...
  current(const std::string &product_session_id, const lingtu::explore::ExploreMapIdentity &map,
          double now_s) const;
