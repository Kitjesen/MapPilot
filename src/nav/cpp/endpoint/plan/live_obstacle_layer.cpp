...
void LiveObstacleLayer::updateFromScan(const SensorOrigin &origin, const std::vector<float> &xyzh,
                                       double stamp_s) {
...
std::vector<DynamicCluster> LiveObstacleLayer::dynamicClusters(std::size_t max_clusters,
                                                               double now_s) {
