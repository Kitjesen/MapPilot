...
struct EndpointState {
  ...
  nav_kernel::Vec3 odom_linear_velocity_body{};
  double odom_yaw_rate{0.0};
  bool odom_velocity_valid{false};
  ...
  // planner input substitution.
  TraversabilityGrid traversability_grid;
  TraversabilityGrid local_traversability_grid;
  ...
  double last_local_traversability_s{0.0};
  double last_local_traversability_receive_s{0.0};
  double last_local_collision_s{0.0};
  double last_local_collision_receive_s{0.0};
  // Source-time watermarks captured on clear. They prevent queued local map
  // products from restoring discarded planner inputs.
  double local_traversability_not_before_s{0.0};
  double local_collision_not_before_s{0.0};
  ...
  std::uint64_t local_traversability_count{0};
  std::uint64_t local_traversability_generation{0};
  std::uint64_t local_traversability_rejected{0};
  std::uint64_t local_collision_count{0};
  std::uint64_t local_collision_rejected{0};
  ...
  double teleop_request_not_before_s{0.0};
};
