...
class RollingExplorationMap {
 public:
  explicit RollingExplorationMap(
  ...
  [[nodiscard]] lingtu::maps::layers::ExplorationGridSnapshot Update(
 ...
 private:
  static lingtu::maps::layers::RollingOccupancyConfig MakeCoreConfig(
