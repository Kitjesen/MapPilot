...
int main() {
  ...
  require(
      lingtu::nav::endpoint::globalPlanStaleReason(
          *first_result,
          11,
          4,
          first_result->result.map_identity).empty(),
  ...
  require(
      lingtu::nav::endpoint::globalPlanStaleReason(
          *first_result,
          11,
          4,
          changed_map) == "active_map_changed_during_planning",
  ...
  require(
      lingtu::nav::endpoint::globalPlanStaleReason(
          *first_result,
          11,
          4,
          std::nullopt) == "active_map_unavailable_after_planning",
