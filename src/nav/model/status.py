...
from nav.model.geometry import distance_xy, point_summary
...
def build_mission_status(
    *,
    ...
    return {
        ...
        "position": {
            "x": round(float(robot_pos[0]), 6),
            "y": round(float(robot_pos[1]), 6),
            "z": round(float(robot_pos[2]), 6),
            "yaw": round(float(robot_yaw), 6),
        },
