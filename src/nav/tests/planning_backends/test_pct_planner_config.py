...
class TestPCTConfig:
    ...
    def test_config_default_node_values(self):
        ...
        from nav.services.plan.global_planner.algorithm.pct.vendor.pct_planner.planner.config.param import ConfigNode
        node = ConfigNode()
    ...
    def test_config_default_planner_values(self):
        ...
        from nav.services.plan.global_planner.algorithm.pct.vendor.pct_planner.planner.config.param import ConfigPlanner
    ...
    def test_config_default_wrapper_values(self):
        ...
        from nav.services.plan.global_planner.algorithm.pct.vendor.pct_planner.planner.config.param import ConfigWrapper
    ...
    def test_config_compose_defaults(self):
        ...
        from nav.services.plan.global_planner.algorithm.pct.vendor.pct_planner.planner.config.param import Config
        cfg = Config()
