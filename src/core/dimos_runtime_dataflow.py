...
def _summarize_gazebo_runtime_report(
    ...
    *,
    ...
    tf_topics = ("/nav/map_cloud", "/nav/registered_cloud")
    tf_ok = (
        ...
        and frames.get("/nav/map_cloud") == "odom"
        and frames.get("/nav/registered_cloud") == "body"
        and _safe_int(point_counts.get("/nav/map_cloud")) > 0
        and _safe_int(point_counts.get("/nav/registered_cloud")) > 0
    )
