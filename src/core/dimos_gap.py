...
DIMOS_REFERENCE_SURFACES: dict[str, dict[str, str]] = {
    ...
    "native_pct_mujoco": {
        "surface": "simulation route execution",
        "requirement": "Native PCT output reaches local planning, path following, and simulated motion without planner fallback.",
    },
    ...
    "primary_chain": [
        {
            ...
            "role": "NavigationModule selects GlobalPlannerService and planner backend",
            "code": [
        ...
        {
            "id": "pct_backend",
            "role": "PCT backend loads tomogram/native runtime and returns global path",
            "code": [
                "src/global_planning/pct_adapters/global_planner_module.py",
                "src/global_planning/pct_planner_runnable/runtime.py",
            ],
            "runtime_evidence_gate": "large_terrain",
        },
        {
        ...
        {
            "id": "native_pct_to_ros2_local_planner",
            "role": "Native PCT path is fed to ROS2 localPlanner/pathFollower",
            "code": [
                "sim/scripts/native_pct_mujoco_gate.py",
                "src/base_autonomy/modules/local_planner_module.py",
                "src/base_autonomy/modules/path_follower_module.py",
            ],
            "runtime_evidence_gate": "native_pct_mujoco",
        },
        {
            "id": "mujoco_motion_executor",
            "role": "Path follower cmd_vel drives the MuJoCo kinematic simulation endpoint",
            "code": [
                "src/drivers/sim/mujoco_driver_module.py",
