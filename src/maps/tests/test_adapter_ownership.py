"""Map transport ownership must stay inside the maps domain."""
...
def test_map_dds_adapter_has_one_canonical_implementation():
    assert (REPO_ROOT / "src/maps/adapters/dds/output.py").is_file()
