...
class DDSMapOutModule(Module, layer=2):
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        self._frame_id = str(default_frame_id or topic_default_frame_id(TOPICS.exploration_grid))
    ...
    def _publish_grid(self, topic: str, grid: dict[str, Any], default_frame_id: str) -> None:
        try:
            self._publisher_for_topic(topic).publish(_to_dds_occupancy_grid(grid, default_frame_id))
        except Exception:
