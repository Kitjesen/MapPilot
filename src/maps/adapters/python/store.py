...
def _native_library_candidates() -> list[Path]:
    ...
    roots = (
        ...
        repo / "build" / "maps-windows" / "Release",
        repo / "build" / "maps-windows" / "Debug",
        repo / "build" / "maps-mapd-core" / "Release",
        repo / "build" / "maps-mapd-core" / "Debug",
        repo / "src" / "maps" / "build" / "Release",
        repo / "src" / "maps" / "build" / "Debug",
