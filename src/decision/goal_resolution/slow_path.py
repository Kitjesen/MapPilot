...
class SlowPathMixin:
    ...
    async def resolve(
        ...
        from .goal_resolver import GoalResult
        from decision.llm.prompt_templates import build_goal_resolution_prompt
    ...
    async def generate_exploration_waypoint(
        ...
        from .goal_resolver import GoalResult
        from decision.llm.prompt_templates import build_exploration_prompt
    ...
    async def vision_grounding(
        ...
        from decision.llm.prompt_templates import build_vision_grounding_prompt
    ...
    async def _call_with_fallback(
        ...
        """调用主 LLM, 失败或空响应则尝试备用。"""
        from decision.llm.llm_client import LLMError
