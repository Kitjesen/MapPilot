...
class VLMSceneAgent:
    ...
    def _check_vision_support(self) -> bool:
        ...
        if hasattr(self._llm, "chat_with_image") or cls_name in ("OpenAIClient", "ClaudeClient"):
            return True
        return False
    ...
    async def _vlm_call_two_images(self, prompt: str, b64_1: str, b64_2: str) -> str:
        ...
        return await self._generic_vision_chat(prompt, b64_1, extra_images=[b64_2])
