...
class LLMModule(Module, layer=4):
    ...
    def _create_client_for(
        ...
        *,
        ...
        from decision.llm.llm_client import LLMConfig, create_llm_client, resolve_llm_backend
    ...
    def reconfigure_backend(
        ...
        **config: Any,
        ...
        from decision.llm.llm_client import available_llm_backends, resolve_llm_backend
