...
def semantic_command_specs(ctx: WiringContext) -> tuple[WireSpec, ...]:
    ...
    specs = [
        ...
        WireSpec("host.bus", "navigation_state", "VectorMemoryModule", "navigation_state"),
        WireSpec("PerceptionModule", "robot_pose", "VectorMemoryModule", "robot_pose"),
        WireSpec("nav.goals", "goal_status", "SemanticPlannerModule", "goal_status"),
        WireSpec("nav.goals", "task_status", "SemanticPlannerModule", "navigation_goal_status"),
        WireSpec("PerceptionModule", "detections_3d", "SemanticPlannerModule", "detections"),
        WireSpec("PerceptionModule", "robot_pose", "SemanticPlannerModule", "robot_pose"),
        WireSpec("PerceptionModule", "robot_pose", "AgentPlannerModule", "robot_pose"),
        WireSpec("PerceptionModule", "observation_image", "AgentPlannerModule", "observation_image"),
        WireSpec("PerceptionModule", "observation_image", "SemanticPlannerModule", "observation_image"),
