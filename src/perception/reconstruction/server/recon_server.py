...
Quick start:
    ...
    python -m perception.reconstruction.server.recon_server
    ...
    python -m perception.reconstruction.server.recon_server --backend gsfusion
...
Examples:
  python -m perception.reconstruction.server.recon_server
  python -m perception.reconstruction.server.recon_server --backend nerfstudio --port 7891
