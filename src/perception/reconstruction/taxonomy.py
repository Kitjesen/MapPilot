"""Versioned semantic taxonomy owned by perception reconstruction."""
...
class SemanticTaxonomy:
    """Validated label ids and display metadata for reconstructed semantics."""
    ...
    def encode(self, labels: Iterable[str], *, excluded: frozenset[str] = frozenset()) -> np.ndarray:
        """Encode normalized labels as stable unsigned 16-bit class ids."""
