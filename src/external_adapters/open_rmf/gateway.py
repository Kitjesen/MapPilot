    ...
    def _lease_command(
        ...
        *,
        ...
        if action in {"acquire", "renew"}:
            if holder != self._config.client_id or not active:
                return False, "gateway_lease_not_owned"
        elif active and holder == self._config.client_id:
...
class GatewayRobotStateSource:
    ...
    def snapshot(self) -> RobotSnapshot:
        ...
        return RobotSnapshot(
            ...
            native_command_accepted=bool(command_boundary.get("last_accepted", False)),
            ...
            native_plan_seen=bool(last_plan.get("seen", False)),
            native_plan_accepted=bool(last_plan.get("accepted", False)),
            ...
            native_goal_reached=bool(last_local.get("goal_reached", False)),
        )
