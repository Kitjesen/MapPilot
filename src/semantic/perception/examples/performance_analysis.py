...
from semantic.perception.local_rolling_grid import LocalRollingGrid
...
from semantic.perception.uncertainty_model import UncertaintyModel
...
class PerformanceAnalyzer:
    ...
    def analyze_uncertainty_computation(self):
        ...
        # 创建测试数据
        from semantic.perception.global_coverage_mask import GlobalCoverageMask
