...
from semantic.perception.baseline_wrappers import create_planner
from semantic.perception.dataset_loader import create_dataset_loader
...
class EndToEndEvaluator:
    ...
    def _evaluate_scene_method(
        ...
        if path_metrics_list:
            from semantic.perception.evaluation_framework import PathMetrics
