...
from core.transport.json_codec import FORMAT as LCM_PAYLOAD_FORMAT
from core.transport.json_codec import loads_message
...
def loads_endpoint_message(binding: LCMEndpointBinding, data: Any) -> Any:
    ...
    The adapter also accepts the generic ``core.transport.json_codec`` envelope
    ...
    return _decode_payload(schema, envelope.get("payload"))
