...
from semantic.reconstruction.server.backends.base import Keyframe

logger = logging.getLogger("semantic.reconstruction.bag_reader")
...
def read_rgb_d_bag(
    ...
    *_topic      : 手动指定话题名，None = 自动检测
    ...
    # 返回 Keyframe 对象列表
    from semantic.reconstruction.dataset_io import load_dataset
...
def read_lidar_bag(
    ...
    *,
    ...
    # 写 PLY
    from semantic.reconstruction.ply_writer import save_ply
