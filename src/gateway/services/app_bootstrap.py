...
CLIENT_LINKS: dict[str, str] = {
    ...
    "navigation_goal_status": "/api/v1/navigation/goals/{request_id}",
    "navigation_task_status": "/api/v1/navigation/tasks/{task_id}",
    ...
    "inspection_tasks": "/api/v1/inspection/tasks",
    "inspection_task_status": "/api/v1/inspection/tasks/{task_id}",
    "inspection_task_report": "/api/v1/inspection/tasks/{task_id}/report",
    "inspection_task_pause": "/api/v1/inspection/tasks/{task_id}/pause",
    "inspection_task_resume": "/api/v1/inspection/tasks/{task_id}/resume",
    "inspection_task_cancel": "/api/v1/inspection/tasks/{task_id}/cancel",
    "inspection_status": "/api/v1/inspection/status",
    "navigation_cancel": "/api/v1/navigation/cancel",
    "navigation_task_cancel": "/api/v1/navigation/tasks/{task_id}/cancel",
    "navigation_task_pause": "/api/v1/navigation/tasks/{task_id}/pause",
    "navigation_task_resume": "/api/v1/navigation/tasks/{task_id}/resume",
    "navigation_resume": "/api/v1/navigation/resume",
    "stop": "/api/v1/stop",
    "estop_reset": "/api/v1/estop/reset",
    ...
    "map_operation_status": "/api/v1/maps/operations/{operation_id}",
    "map_operation_cancel": "/api/v1/maps/operations/{operation_id}/cancel",
    "map_operation_retry": "/api/v1/maps/operations/{operation_id}/retry",
    ...
    "explore_directed": "/api/v1/explore/directed",
...
CLIENT_ENDPOINTS: dict[str, dict[str, dict[str, str]]] = {
    ...
    "control": {
        ...
        "navigation_task_cancel": {"method": "POST", "path": CLIENT_LINKS["navigation_task_cancel"]},
        "navigation_task_pause": {"method": "POST", "path": CLIENT_LINKS["navigation_task_pause"]},
        "navigation_task_resume": {"method": "POST", "path": CLIENT_LINKS["navigation_task_resume"]},
    ...
    "map": {
        ...
        "map_delete": {"method": "DELETE", "path": CLIENT_LINKS["map_delete"]},
        "map_build_occupancy": {
            "method": "POST",
        ...
        "map_operations": {
            "method": "GET",
            "path": CLIENT_LINKS["map_operations"],
        },
        "map_operation_status": {
            "method": "GET",
            "path": CLIENT_LINKS["map_operation_status"],
        },
        "map_operation_cancel": {
            "method": "POST",
            "path": CLIENT_LINKS["map_operation_cancel"],
        },
        "map_operation_retry": {
            "method": "POST",
            "path": CLIENT_LINKS["map_operation_retry"],
        },
        ...
        "explore_directed": {"method": "POST", "path": CLIENT_LINKS["explore_directed"]},
        "explore_directed_clear": {
            "method": "POST",
    ...
    "ops": {
        ...
        "inspection_task_list": {
            "method": "GET",
            "path": CLIENT_LINKS["inspection_tasks"],
        },
        "inspection_task_start": {
            "method": "POST",
            "path": CLIENT_LINKS["inspection_tasks"],
        },
        "inspection_task_status": {
            "method": "GET",
            "path": CLIENT_LINKS["inspection_task_status"],
        },
        "inspection_task_report": {
            "method": "GET",
            "path": CLIENT_LINKS["inspection_task_report"],
        },
        "inspection_task_pause": {
            "method": "POST",
            "path": CLIENT_LINKS["inspection_task_pause"],
        },
        "inspection_task_resume": {
            "method": "POST",
            "path": CLIENT_LINKS["inspection_task_resume"],
        },
        "inspection_task_cancel": {
            "method": "POST",
            "path": CLIENT_LINKS["inspection_task_cancel"],
        },
